...
namespace DeliveryBookingMVC.Controllers
{
    public class BookingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderID,CustomerId,ExecutiveId,Address,City,PinCode,Phone,DateandTimeOfPickup,WeightOfPackage,Price,Status")] Booking booking)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,CustomerId,ExecutiveId,Address,City,PinCode,Phone,DateandTimeOfPickup,WeightOfPackage,Price,Status")] Booking booking)
        {
